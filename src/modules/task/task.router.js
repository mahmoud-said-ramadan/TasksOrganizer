...
router.put("/updateTaskStatus", validation(validators.updateTaskStatus), auth, taskController.updateTaskStatus)
router.put("/deleteTask", validation(validators.deleteTask), auth, taskController.deleteTask)
